...
const ModalCreate: FC = () => {
    ...
    return (
        <React.Fragment>
            <Button onClick={() => setState(true)}  sx={{color: 'white', background: '#375e68'}} variant="outlined">
                Create Contact
            </Button>
            <Drawer
            anchor={'top'}
            ...
            >
                ...
                >
                    ...
                    />
                    <Button onClick={handleAddContact} sx={{color: 'white', background: '#375e68', height: '6.5vh'}} variant="contained">
                        ADD NEW CONTACT
                    </Button>
                </Box>
            </Drawer>
